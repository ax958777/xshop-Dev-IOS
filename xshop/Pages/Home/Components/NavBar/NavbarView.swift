        ...
        GeometryReader { geometry in
            HStack {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    MenuLink(icon: "house", title: "PlantIdentifier") {
                        viewModel.handleMenuAction(.plantIdentifier)
                    }
                    MenuLink(icon: "house", title: "3D Models") {
                        viewModel.handleMenuAction(.models)
                    }
